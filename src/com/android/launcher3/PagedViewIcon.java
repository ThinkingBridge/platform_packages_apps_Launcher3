...
public class PagedViewIcon extends TextView {
	...
	public void applyFromApplicationInfo(AppInfo info, boolean scaleUp,
		...
		mPressedCallback = cb;
		if (info.packageName.trim().equals("com.android.deskclock")) {
			setUpClock();
		} else if (info.packageName.trim()
	...
	public void draw(Canvas canvas) {
		...
		canvas.clipRect(getScrollX(), getScrollY() + getExtendedPaddingTop(),
				...
				Region.Op.INTERSECT);
		getPaint().setShadowLayer(BubbleTextView.SHADOW_SMALL_RADIUS, 0.0f,
				0.0f, BubbleTextView.SHADOW_SMALL_COLOUR);
		super.draw(canvas);
		canvas.restore();
	}
